# "Sistemas Operativos - Open Source" Class Exercises Repository
...
<br>
<br>
Welcome to the "Sistemas Operativos - Open Source" exercises repository!

<h2>Overview</h2>
    This repository contains all the exercises completed during a class mostly about linux, which is part of the Network Administration and Cybersecurity course at CESAE (Centro para Desenvolvimento das Competências Digitais).
    The course was in Portuguese so the content of this repository will be aswell.

<h2>About the Course</h2> 
    This class focused on various topics such as installation and configuration of an open source operating system, resource optimization, application installation, system configuration (such as DNS services, DHCP, email, backups, etc.) and troubleshooting.
